...
** School_library ** is an app used to keep records of books and records of people that rent books from the library.
...
- Clone this repository to your desired folder: git@github.com:Lancelot-SO/school_library.git
